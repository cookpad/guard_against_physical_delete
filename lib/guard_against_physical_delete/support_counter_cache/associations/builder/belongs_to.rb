          ...
          def self.included(obj)
            obj.class_eval do
              ...
              def add_logical_delete_counter_cache_callback(reflection)
                ...
                logical_delete_method_name = "belongs_to_counter_cache_before_logical_delete_for_#{name}".to_sym
                ...
                model.before_update(logical_delete_method_name, revive_method_name)
              end
            end
          end
        end
